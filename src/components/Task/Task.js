    ...
    return (
        <div className="card-ticket bg-opacity-90 group hover:bg-opacity-100" draggable="true">
            <header className="card-header flex items-center">
                    <span>
                <h3 className="card-priority-low">{task.priority}</h3></span>
                <>
                <Link to='/details/${task._id}' className="absolute top-0 right-0 flex items-center justify-center hidden w-5 h-5 mt-3 mr-2 text-gray-500 rounded hover:bg-gray-200 hover:text-gray-700 group-hover:flex">
